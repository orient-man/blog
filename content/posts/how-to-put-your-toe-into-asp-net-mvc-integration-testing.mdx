...
[^1]: I cannot fail to mention [Maciej Aniserowicz](https://twitter.com/maniserowicz) talk which convinced me that I should have used [Nancy](http://nancyfx.org/) instead of ASP.NET MVC in the first place [but... it's to late to apologize ;)](http://www.youtube.com/watch?v=ePyRrb2-fzs)
