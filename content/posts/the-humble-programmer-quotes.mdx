...
> guidance. By definition this approach is only applicable when we restrict
> ourselves to intellectually manageable programs, but it provides us with
> effective means for finding a satisfactory one among these.

Most striking fragment:

> The competent programmer is fully aware of the strictly limited size of his
> own skull and among other things he avoids clever tricks like the plague.
