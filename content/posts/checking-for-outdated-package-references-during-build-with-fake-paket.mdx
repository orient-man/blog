...
Yep, that's F# code! I use [FAKE](https://fake.build/) for my build scripts, so you should because it's great! FAKE gives me easy domain-specific language (DSL) for build tasks together with power of F#. Using FAKE's ProcessHelper I can run _paket outdated_ command and feed output into my function:
