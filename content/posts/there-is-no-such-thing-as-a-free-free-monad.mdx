...
This post was supposed to be about [DurableTask](https://github.com/Azure/durabletask) ~~framework~~library and how we use it at [FinAi](https://finai.com/) to orchestrate biometric authentication process. In the meantime, I got inspired by Mark Seemann's writings about "pure interactions". Go [read it](http://blog.ploeh.dk/2017/07/10/pure-interactions/) - it's wonderful! I call DurableTask _library_ because it's very easy to _decouple_ your application logic from it (at least in F#). Yeah!, _decoupling_ is great, isn't it?  Believe me, you can go astray with _decoupling_. See for yourself.
