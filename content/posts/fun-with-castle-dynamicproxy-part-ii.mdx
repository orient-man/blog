...
It's time for another adventure with [Castle.DynamicProxy](http://www.castleproject.org/projects/dynamicproxy/). One of the few things I really like in C++ is [RAII](http://en.wikipedia.org/wiki/Resource_Acquisition_Is_Initialization) - for example you can write code like this:
