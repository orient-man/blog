# Plan: Generate tasks.md for 005-syntax-highlighting

## Target File
`specs/005-syntax-highlighting/tasks.md`

## What to Write

The full tasks.md content below should be written to the target file.
