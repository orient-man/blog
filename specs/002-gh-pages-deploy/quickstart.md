...
1. Navigate to the repository on GitHub:
   `https://github.com/orient-man/blog`
...
> (`orient-man.github.io/blog`) immediately after first deployment,
...
Navigate to:
`https://github.com/orient-man/blog/actions`
...
1. Navigate to:
   `https://github.com/orient-man/blog/actions/workflows/deploy.yml`
...
**Symptom**: `orient-man.github.io/blog` works but `blog.orientman.com` shows an error or DNS failure.
